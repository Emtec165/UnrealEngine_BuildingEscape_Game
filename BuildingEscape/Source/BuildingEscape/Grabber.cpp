...
void UGrabber::BeginPlay()
{
	...
	if (PhysicsHandle) { /*Physics Handle found*/}
	else { UE_LOG(LogTemp, Error, TEXT("%s don't have UPhysicsHandleComponent"), *GetOwner()->GetName()) }
	...
	else { UE_LOG(LogTemp, Error, TEXT("%s don't have UInputComponent"), *GetOwner()->GetName()) }
}
